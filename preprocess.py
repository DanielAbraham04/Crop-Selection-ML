...
def process(path):
	...
	with open('static/results/data1.csv', 'w',newline='') as myFile:
		writer = csv.writer(myFile)
		writer.writerows(ss)
	
	with open('static/results/data2.csv', 'w', newline='') as myFile:
		writer = csv.writer(myFile)
		writer.writerows(ss1)
	
	data = pd.read_csv('static/results/data2.csv')
	print(data.head())
	...
	#scatterplot
	scatter_matrix(data)
	plt.savefig('static/results/scattermatrix.png')
